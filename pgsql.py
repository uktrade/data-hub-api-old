...
class PgSQLEntityContainer(SQLEntityContainer):
    ...
    set to the Python psycopg2 module."""
...
class PgSQLEntityCollectionBase(SQLCollectionBase):
	...
	This class provides some PgSQL specific mappings for certain
...
class PgSQLAssociationCollection(
		PgSQLEntityCollectionBase,
		SQLAssociationCollection):
    """PgSQL-specific collection for symmetric association sets"""
    pass


class PgSQLForeignKeyCollection(
		PgSQLEntityCollectionBase,
...
class PgSQLReverseKeyCollection(
		PgSQLEntityCollectionBase,
